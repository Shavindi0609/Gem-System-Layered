...
public class GemsController implements Initializable {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        if (isValidName && isValidColour && isValidSize && isValidPrice && isValidQty && isValidIsCetified) {
            ...
            if (isSaved) {
                refreshPage();
                new Alert(Alert.AlertType.INFORMATION, "Gem updated...!").show();
            } else {
                new Alert(Alert.AlertType.ERROR, "Failed to update gem...!").show();
            }
        }
