...
//            return;
    ...
    public void getOrderOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        SupplierOrderDTO supplierOrder = new SupplierOrderDTO(orderId, supplierId, orderDate, paymentId, totalAmount, paymentMethod, supplierorderDetails);
    ...
    public void cmbSupplierIdOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        if (selectedSupplierId != null) {
            SupplierDTO supplier = supplierOrderBO.findByIdSupplier(selectedSupplierId);
    ...
    public void cmbGemIdOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        if (selectedGemId != null) {
            GemDTO gem = supplierOrderBO.findByIdGem(selectedGemId);
